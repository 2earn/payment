...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Payment-2earn - Distributed Monolith Payment Management</title>
    ...
    <body class="bg-gray-50 dark:bg-gray-900">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Payment-2earn</h1>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Distributed Monolith</p>
                        </div>
                    </div>
                    @if (Route::has('login'))
        ...
        <section class="gradient-bg text-white py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-5xl font-bold mb-6">Distributed Payment System</h2>
                <p class="text-xl mb-8 text-purple-100">
                    Robust solution for payment processing with detailed JSON reports
                </p>
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <section class="mb-16">
                <h3 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">System Architecture</h3>
...
<pre class="text-sm">{
  ...
  "timestamp": "2025-10-15T14:30:00Z"
                    ...
                    <div class="flex flex-wrap justify-center gap-6">
                        <div class="text-center">
                            <div class="bg-red-100 dark:bg-red-900 px-6 py-3 rounded-lg">
                                <span class="text-xl font-bold text-red-600 dark:text-red-400">Laravel 11.x</span>
                            </div>
                        </div>
                        <div class="text-center">
                            <div class="bg-purple-100 dark:bg-purple-900 px-6 py-3 rounded-lg">
                                <span class="text-xl font-bold text-purple-600 dark:text-purple-400">PHP 8.2+</span>
                            </div>
                        </div>
                        <div class="text-center">
                            <div class="bg-blue-100 dark:bg-blue-900 px-6 py-3 rounded-lg">
                                <span class="text-xl font-bold text-blue-600 dark:text-blue-400">MySQL / PostgreSQL</span>
                            </div>
                        </div>
                        <div class="text-center">
                            <div class="bg-green-100 dark:bg-green-900 px-6 py-3 rounded-lg">
                                <span class="text-xl font-bold text-green-600 dark:text-green-400">REST API</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="text-center">
                <div class="bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg shadow-xl p-12 text-white">
                    <h3 class="text-3xl font-bold mb-4">Ready to Get Started?</h3>
                    <p class="text-xl mb-8 text-purple-100">Check out the complete documentation to integrate Payment-2earn</p>
                    <div class="flex justify-center gap-4 flex-wrap">
                        <a href="/README.md" class="px-8 py-3 bg-white text-purple-600 rounded-lg font-semibold hover:bg-gray-100 transition">
                            📖 Documentation
                        </a>
                        <a href="#" class="px-8 py-3 bg-purple-800 text-white rounded-lg font-semibold hover:bg-purple-900 transition">
                            🚀 Get Started
                        </a>
                    </div>
                </div>
